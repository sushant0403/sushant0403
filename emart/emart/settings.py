...
SECRET_KEY = 'django-insecure-w+^80c8fz53ai$zm)#e9_(f&6py0@!)_t%n17ocbt_0r=$el*#'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'eapp.context_processor.menu_links',
                'cart.context_processor.menu_links'
